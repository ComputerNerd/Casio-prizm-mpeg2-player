...
MKG3A=mkg3a
RM=rm
CFLAGS=-mb -m4a-nofpu -Isrc -O3 -fmerge-all-constants -ggdb3 -mhitachi -fuse-linker-plugin -flto -Wall -Wextra -I../../include -lgcc -L../../lib -I../libmpeg2-0.5.1/include 
