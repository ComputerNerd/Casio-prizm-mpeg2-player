...
MKG3A=mkg3a
RM=rm
CFLAGS=-m4a-nofpu -mb -Isrc -O2 -fmerge-all-constants -ggdb -mhitachi -fuse-linker-plugin -fshort-enums -flto -Wall -Wextra -I../../include -lgcc -L../../lib -I../libmpeg2-0.5.1/include 
